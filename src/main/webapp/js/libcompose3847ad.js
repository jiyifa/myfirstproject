...
_oTop.logKVOnlineDoc&&_oTop.logKVOnlineDoc("copy_url_to_share");
};
},_cpsData:function(){
...
},{_TEMPLATE:{_DLG:TE(['$@$if($sCopy2shareUrl$)$@$','<div style="*width:466px;text-align:left; padding:22px 27px 30px;">','<div style="font-size:14px;line-height:20px;font-weight:500;color:#000;margin-bottom:14px;">\u90AE\u4EF6\u9080\u8BF7</div>','<div style="margin:0 0 7px; overflow:hidden; zoom:1;">','<div class="left" style="width:40px; white-space:nowrap; text-align:right;height:26px;line-height:26px;">\u6536\u4EF6\u4EBA\uFF1A</div>','<style>.onlineDoc_receiver_divText .addr_base{margin-top:1px;}.onlineDoc_receiver_divText .addr_text{margin-top:3px;}</style>','$@$if($addredit$)$@$','<div id="toAddrArea" class="noime div_txt f_size onlineDoc_receiver_divText" style="height:22px;line-height:22px;margin-left:60px;width:372px;"></div>','<div id="addrUrlCreator" style="display:none;" class="attbg bd urlcreator_to"><span class="ico_urlcreator"></span>\u7F51\u9875\u751F\u6210\u52A9\u624B<a class="ico_close_mini" id="btnRmUrlCreator"></a></div>','<div id="addrQzone" style="display:none;" class="attbg bd urlcreator_to"><span class="ico_addrqzone"></span>\u53D1\u8868\u5230\u6211\u7684Qzone<a class="ico_close_mini" id="btnRmQzone"></a></div>','$@$else$@$','<div class="noime div_txt f_size settingtable graytext onlineDoc_receiver_divText" style="height:22px;line-height:22px;margin-left:60px;width:372px;">','$@$for($addrs$)$@$$@$eval htmlEncode($nick$)$@$; $@$endfor$@$','</div>','$@$endif$@$','<div class="clr"></div>','</div>','<div id="subjectArea" style="margin:0 0 9px; overflow:hidden; zoom:1;">','<div class="left" style="width:48px; text-align:right;height:26px;line-height:26px;">\u4E3B\u9898\uFF1A</div>','<div style="margin-left:60px;"><input id="subject" class="txt" type="text" style="width:372px;height:24px;line-height:24px;" tabindex="2"/></div>','<div class="clr"></div>','</div>','<div id="attachArea" style="margin:0 0 10px; overflow:hidden; zoom:1;display:none">','<div class="left" style="width:48px; text-align:right;height:18px;line-height:18px;">\u9644\u4EF6\uFF1A</div>','<div id="attachList" style="margin-left:60px;line-height:18px;width:380px;overflow:hidden;white-space:nowrap;">','<span>\u9644\u4EF6\u52A0\u8F7D\u4E2D...</span>','</div>','<div class="clr"></div>','</div>','<div style="margin:0 0 10px;zoom:1;">','<div class="left" style="width:48px; text-align:right;height:24px;line-height:24px;">\u6B63\u6587\uFF1A</div>','<style>.qmEditorContent{height: 49px;}</style>','<div style="margin-left:60px;"><div id="QMEditorArea" style="height:52px;" ></div></div>','<div class="clr"></div>','</div>','<div style="overflow:hidden; zoom:1;padding:0 0 0 59px;text-align:left;">','<div style="float:right;margin-top:4px;" id="jumpToNewWin">','<input type="button" class="ico_input icon_switch_compose" style="margin-right:4px;margin-bottom:3px;vertical-align:middle;">','<a href="javascript:;">\u5207\u6362\u5230\u5B8C\u6574\u5199\u4FE1\u6A21\u5F0F</a>','</div>','<a class="btn_blue btn_space" tabindex="4" id="sendBtn" style="margin-right:5px;">\u53D1\u9001</a>','<a class="btn_gray" tabindex="5" id="cancelBtn">\u53D6\u6D88</a>','</div>','<div style="overflow:hidden; zoom:1;padding-top:22px;margin-top:26px;border-top:1px solid #e2e2e2;text-align:left;">','<a class="btn_gray right" initlized="true" id="btn_copy2share">\u590D\u5236\u9080\u8BF7\u94FE\u63A5</a>','<span id="span_copySuc" style="display:none;float: right;color: #9e9b9b;margin-top: 4px;margin-right: 10px;">\u5DF2\u590D\u5236</span>','<textarea id="textarea_copy" readonly style="padding:0px;margin:0px;position:absolute;border:0px;left:-9999px;">$sCopy2shareUrl$</textarea>','<div style="font-size:14px;line-height:24px;font-weight:500;color:#000;">\u94FE\u63A5\u9080\u8BF7</div>','</div>','</div>','$@$else$@$','<div style="*width:466px;text-align:left; padding:10px 15px 10px 10px;">','<div style="margin:0 0 5px; overflow:hidden; zoom:1;">','<div style="float:right;margin:0;" id="jumpToNewWin">','<input type="button" class="ico_input icon_switch_compose" style="margin-right:4px;margin-bottom:3px;vertical-align:middle;">','<a href="javascript:;">\u5207\u6362\u5230\u5B8C\u6574\u5199\u4FE1\u6A21\u5F0F</a>','</div>','<div class="clr"></div>','</div>','<div style="margin:0 0 5px; overflow:hidden; zoom:1;">','<div class="left" style="width:50px; padding:0 10px 0 0; padding-top:2px\9;  text-align:right;height:24px;line-height:24px;">\u6536\u4EF6\u4EBA\uFF1A</div>','$@$if($addredit$)$@$','<div id="toAddrArea" class="noime div_txt f_size" style="line-height:16px;margin-left:60px;width:399px;"></div>','<div id="addrUrlCreator" style="display:none;" class="attbg bd urlcreator_to"><span class="ico_urlcreator"></span>\u7F51\u9875\u751F\u6210\u52A9\u624B<a class="ico_close_mini" id="btnRmUrlCreator"></a></div>','<div id="addrQzone" style="display:none;" class="attbg bd urlcreator_to"><span class="ico_addrqzone"></span>\u53D1\u8868\u5230\u6211\u7684Qzone<a class="ico_close_mini" id="btnRmQzone"></a></div>','$@$else$@$','<div class="noime div_txt f_size settingtable graytext" style="line-height:16px;margin-left:60px;width:399px;">','$@$for($addrs$)$@$$@$eval htmlEncode($nick$)$@$; $@$endfor$@$','</div>','$@$endif$@$','<div class="clr"></div>','</div>','<div id="subjectArea" style="margin:0 0 5px; overflow:hidden; zoom:1;">','<div class="left" style="width:50px; padding:0 10px 0 0; padding-top:2px\9; text-align:right;height:25px;line-height:25px;">\u4E3B\u9898\uFF1A</div>','<div style="margin-left:60px;"><input id="subject" class="txt" type="text" style="width:399px;height:25px;line-height:25px;" tabindex="2"/></div>','<div class="clr"></div>','</div>','<div id="attachArea" style="margin:0 0 5px; overflow:hidden; zoom:1;display:none">','<div class="left" style="width:50px; padding:0 10px 0 0; padding-top:2px\9; text-align:right;height:25px;line-height:25px;">\u9644\u4EF6\uFF1A</div>','<div id="attachList" style="float:left;line-height:25px;width:400px;overflow:hidden;white-space:nowrap;">','<span>\u9644\u4EF6\u52A0\u8F7D\u4E2D...</span>','</div>','<div class="clr"></div>','</div>','<div style="margin:0 0 5px;zoom:1;">','<div class="left" style="width:50px; padding:0 10px 0 0; padding-top:2px\9; text-align:right;height:24px;line-height:24px;">\u6B63\u6587\uFF1A</div>','<div style="margin-left:60px;"><div id="QMEditorArea" style="height:150px;" ></div></div>','<div class="clr"></div>','</div>','<div style="overflow:hidden; zoom:1;padding:4px 8px 4px 60px;text-align:left;">','<a class="btn_blue btn_space" tabindex="4" id="sendBtn" style="margin-right:5px;">\u53D1\u9001</a>','<a class="btn_gray" tabindex="5" id="cancelBtn">\u53D6\u6D88</a>','</div>','</div>','$@$endif$@$']),_ATTACHLIST:TE(['$@$if($list.length$>5)$@$','<div style="height:125px;overflow:auto;">','$@$for($list$)$@$','<div aid="$id$" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">','<input type="button" ','$@$if($attachtype$=="onlinedoc")$@$','class="ico_editDoc_Small" style="vertical-align:text-bottom;margin:0 5px 1px 0;*margin-bottom:-1px;" ','$@$else$@$','class="ico_att" style="margin:0 3px 2px 0" ','$@$endif$@$','tabindex="-1">','<span>$@$html($name$)$@$</span> ($@$if($newname$)$@$$newname$ $@$endif$@$<span byte="$byte$" class="addrtitle">$size$</span>)','</div>','$@$endfor$@$','</div>','$@$else$@$','$@$for($list$)$@$','$@$if($_idx_$<=5)$@$','<div aid="$id$" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">','<input type="button" ','$@$if($attachtype$=="onlinedoc")$@$','class="ico_editDoc_Small" style="vertical-align:text-bottom;margin:0 5px 1px 0;*margin-bottom:-1px;" ','$@$else$@$','class="ico_att" style="margin:0 3px 2px 0" ','$@$endif$@$','tabindex="-1">','<span>$@$html($name$)$@$</span>&nbsp;<span class="addrtitle">($@$if($newname$)$@$$newname$ $@$endif$@$<span byte="$byte$">$size$</span>)</span>','</div>','$@$endif$@$','$@$endfor$@$','$@$endif$@$'])}});
