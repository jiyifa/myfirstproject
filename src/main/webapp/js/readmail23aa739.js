...
var _sReplaceStr=_oTop.htmlEncode(_oLocNodeData.sValue).replace(new RegExp('('+_oLocNodeData.sLocation+')','g'),function(_asLoc){
...
},processSpreadEmailDisPlayForWebmail:function(){
var _oSelf=this,_oTop=getTop(),webmailAliasDom,notWebmailAliasDom,containerDom;
switch(_oSelf._msModuleName)
{case "qmConvMail":
containerDom=_oSelf.S(_ID._sSubMail+"0");
break;
case "qmAdSubMailML":
if(containerDom=_oSelf.S('readxqqmailIfarme'))
{
containerDom=containerDom.contentWindow.document.body;
break;
}
default:
containerDom=_oSelf.S(_ID._sSubMail)||_oSelf._moWin.document.body;
}webmailAliasDom=_oTop.finds(".qqmail_spread_mail_webmail_content",containerDom);
notWebmailAliasDom=_oTop.finds(".qqmail_spread_mail_not_webmail_content",containerDom);
if(!(webmailAliasDom&&webmailAliasDom.length>0&&notWebmailAliasDom&&notWebmailAliasDom.length>0))
{
return;
}
webmailAliasDom=webmailAliasDom[0];
notWebmailAliasDom=notWebmailAliasDom[0];
_oTop.show(webmailAliasDom,true);
_oTop.show(notWebmailAliasDom,false);
...
_oSelf.processSpreadEmailDisPlayForWebmail();
...
{
loadJsFile("$js_path$qmtranslate24e6ae.js",true,_aoLoadWin.document,function(){
waitFor(function(){
...
loadJsFile("$js_path$com/kits/qmpreviewer38b96c.js",true,_oTop.document,function(){
_afComplete&&_afComplete(_oTop.QMPreviewer);
});
}
...
E({bBigAttach:"bigattach",sName:"filename",sUriFileName:"urifilename",sDown:"down",sDownPage:"downpage",sUrl:"url",sType:"viewmode",sParse2OnlineDocUrl:"sParse2OnlineDocUrl",sBytesize:"filebyte",sThumb:"iconurl",sFileIdx:"idx",sAttid:"attid",sFid:"fid",sExptime:"exptime",bIsTimeout:"timeout"},function(_aoItem,_asIdx){
...
_oTop.loadingBox({model:"\u53CD\u5783\u573E",js:["$js_path$qmantispam264eed.js"],oncheck:function(){
...
{
_oLoadScriptFiles.push("$js_path$libcompose3847ad.js");
}
if("1"==getTop().gbBackGroundSend&&!getTop().BackGroundSend)
{
_oLoadScriptFiles.push("$js_path$backsend2b1861.js");
}
...
loadingBox({model:"\u53CD\u5783\u573E",js:["$js_path$qmantispam264eed.js"],oncheck:function(){
return !!getTop().QMAntiSpam;
},onload:function(){
