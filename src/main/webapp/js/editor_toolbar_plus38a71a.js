...
_abIsOk&&_oTop.goUserInfo.get("NetDisk").bIsSpread&&_oTop.loadJsFile("$js_path$webp/qmnetdisk38a714.js",true,_oTop.document,function(){
...
j.addClass(m,'opa50');
j.loadJsFileToTop(['$js_path$editor_toolbar_ext250c75.js']);
a.waitFor(function(){
