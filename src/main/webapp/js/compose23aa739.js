...
var _oUrls=["/cgi-bin/addressbook/addr_listall?","/qqemail/email/today?","/cgi-bin/cardlist?ListType=Cards&Cate1Idx=listall&t=card&loc=cardlist,cardlist,fromtab,1&","/cgi-bin/readtemplate?t=compose&s=cnew&","/cgi-bin/grouplist?t=compose_group&","/cgi-bin/note_list?","/cgi-bin/mail_list?folderid=8&t=mail_list_group&","/cgi-bin/readtemplate?t=compose_audiomail&","/cgi-bin/addr_listall?func=birthcard&t=birth_friendlist&","/cgi-bin/readtemplate?t=compose_video&","/cgi-bin/readtemplate?t=compose_postcard&","/cgi-bin/readtemplate?t=compose_drift&maxage=0&"];
...
var _oTop=getTop();
_oTop.loadJsFileToTop(['$js_path$editor_toolbar_ext250c75.js']);
...
if(_oImgNode)
{
_oImgNode.src=_oTop.getRes('$images_path$function/local_wait1e9c5d.gif');
}
else{
...
return _oSelf._oPlaceholderImgTpl.replace({id:_sId,url:_oTop.htmlEncode(_asPreUrl+_asFilePath),img:_oTop.getRes('$images_path$function/local_wait1e9c5d.gif')});
};
},analyse:function(){
var _oSelf=this;
...
if(_oFile.upload())
{
_oImgNode.src=_oTop.getRes('$images_path$function/local_uploading1e9c5d.gif');
...
_oTop.loadJsFile("$js_path$qmlunar24e6ae.js",true);
_oTop.loadJsFile("$js_path$qmdatectrl24e6b9.js",true);
...
_oQuickAddrDiv.innerHTML=_oTop.T(['<div style="padding:155px 0 0;text-align:center;">',_sType=='loading'?'<img src="$images_path$ico_loading11e9c5d.gif" align="center"/> \u52A0\u8F7D\u4E2D...':'<a href="javascript:\'\'" onclick="return getTop().QMAddress.$fun$();">$content$</a>','</div>']).replace({images_path:_oTop.getPath("image"),fun:'initAddress',content:_aoParam.sMsg});
}
...
_oDragSelf._moImgDragUpload=_oTop.QMFileUpload.create('drag',{bNoStyle:true,oContainer:_oDragSelf._moCfg.oImgUploadArea,sDragLeaveMsg:'<div style="'+_sCss+'">\u5C06\u56FE\u7247\u62D6\u62FD\u81F3\u6B64\u533A\u57DF\uFF0C\u53EF\u76F4\u63A5\u6DFB\u52A0\u81F3\u6B63\u6587\u3002</div>',sDragEnterMsg:'<div style="'+_sCss+'">\u91CA\u653E\u9F20\u6807</div>',oComlist:(_oTop.goExpers&&_oTop.goExpers.h5cJsUploadNormal)?["H5CDragFMail","Html5DragMail"]:["Html5DragMail"],onproxyclose:_oDragSelf._onProxyClose(),onselect:function(_aoFiles){
_oDragSelf._hideDragAndDropArea();
...
_oTop.loadJsFileToTop(["$js_path$qmplayer/player38b933.js","$js_path$com/kits/qmpreviewer/js/qmpreviewer392e89.js"]);
_oTop.waitFor(function(){
...
if(/Html5/i.test(_sUploaderName))
{
_bGoFtn=true;
}
else if(/H5C/.test(_sUploaderName))
{
_bGoFtn=false;
}
...
_oDiv.className="attsep";
_oDiv.id="D"+_sName;
_oDiv.innerHTML=this._getFileCellTmpl(_aoFile.get("sUploadMode")).replace({id:_aoFile.get("sId"),name:_sName,value:_oTop.htmlEncode(_aoFile.get("sName")),images_path:_oTop.getPath("image",true),ext:_aoFile.get("sUploadMode"),filename:_oTop.htmlEncode(_aoFile.get("sName")),dispfname:_insertWbr(_aoFile.get("sName")),size:_aoFile.get("nSize")||0,formatsize:this._formatSize(parseInt(_aoFile.get("nSize")||0)),mailattach:_aoFile.get("sUploadMode")=="collection"?[_aoFile.mailid,_aoFile.attachid,_aoFile.attachname].join("|"):"",ftn:_aoFile.get("bUpToFtn"),bOnlineAttach:_aoFile.get('bOnlineAttach'),loading2GifPath:_oTop.getRes('$images_path$ico_loading21e9c5d.gif')});
...
var _oSelf=this;
var _nTotalTimes=60*5,_nIndex=0;
...
var _oTop=getTop();
_oTop.localReloadJsFile("$js_path$libcompose3847ad.js",function(){
...
{
_oTop.loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor38a71a.js"]);
...
{
_oTop.loadJsFileToTop(["$js_path$com/kits/qmfileupload/js/qmfileupload24e6ae.js"]);
}
...
{
_oTop.loadJsFileToTop(["$js_path$backsend2b1861.js"]);
}
_oTop.loadJsFileToTop(["$js_path$composeresp2ebe07.js"]);
},0);
...
var _sReplaceStr=_oTop.htmlEncode(_oLocNodeData.sValue).replace(new RegExp('('+_oLocNodeData.sLocation+')','g'),'<span class="js_location_string" style="border-bottom: 1px dashed rgb(171, 171, 171); z-index: 1; position: static;">$1</span>');
...
if(_oTop.gbIsIE&&_oWin.mail_content_for_script_only_use_in_IE_replay&&_oCompose.S("pre_mail_content_for_script_only_use_in_IE_replay"))
{
var mailContentForIE=_oCompose.S("pre_mail_content_for_script_only_use_in_IE_replay").innerHTML;
_sSource=_sSource.replace(mailContentForIE,_oWin.mail_content_for_script_only_use_in_IE_replay);
}
if(!_bNoMore)
{
...
var _oTop=getTop(),_sKey=(new Date()).valueOf(),_sTitle="",_sDesc="",_oImgPath=[],goAppScanUploadNameSpace=(_oTop.goAppScanUploadNameSpace||(_oTop.goAppScanUploadNameSpace={})),_sDefaultPdfIconUrl=_oTop.getRes('$images_path$icon_scan_pdf347b21.png');
...
var _oMacTemplate=_oTop.T(['<div id="optContainer">','<div class="dialog_feedback">','<img class="dialog_icon" style="margin:1px 14px -4px 0;" src="$images_path$snip_74x741e9c5d.jpg" />','<div class="dialog_f_c" id="setupMsg" style="margin-left:84px;white-space:nowrap;">','<div class="dialog_f_t">\u8BF7\u5B89\u88C5Snip\u622A\u5C4F\u5DE5\u5177\uFF0C\u5B89\u88C5\u540E\u53EF\u4EE5\u5728QQ\u90AE\u7BB1\u4E2D\u4F7F\u7528\u622A\u5C4F\u529F\u80FD\u3002</div>','<div class="dialog_f_d">\u5982\u5DF2\u5B89\u88C5\uFF0C\u8BF7\u5728Snip\u7684\u504F\u597D\u8BBE\u7F6E\u4E2D\u5173\u8054QQ\u90AE\u7BB1\u3002</div>','</div>','</div>','</div>']),_macSetupTemplate=_oTop.T(['<div id="snipFail"  style="display:none">\u5B89\u88C5\u5C1A\u672A\u6210\u529F\uFF0C\u8BF7\u786E\u8BA4\u662F\u5426\u5DF2\u7ECF\u4E0B\u8F7D\u5E76\u6210\u529F\u5B89\u88C5Snip\u3002</div>','<div id="snipMsg" ><div class="b_size bold">\u68C0\u6D4BSnip\u5B89\u88C5\u72B6\u6001</div>','<div style="margin:5px 0 0;" class="graytext">\u4E0B\u8F7D\u5E76\u6210\u529F\u5B89\u88C5Snip\u540E\u8BF7\u68C0\u6D4B\u5B89\u88C5\u72B6\u6001\u3002</div></div >']);
var _sFunc=_oTop.TE([_oTop.gbIsIE||_oTop.gbIsFF?'<input hideFocus type="button"  onmousedown="return false" unselectable="on" style="margin:2px 5px 0;" class="ico_att"/>\u62D6\u62FD\u4E0A\u4F20\u9644\u4EF6<br>':'',_bIsNewSC?'':'<input hideFocus type="button"  style="margin:2px 5px 0;" class="ico_attbig"/>\u8D85\u5927\u9644\u4EF6<br>','<input hideFocus style="background: url($images_path$/newicon/compose207c92.png) no-repeat 0 -120px;margin:2px 5px 0;height:16px;width:16px;padding:0;border:0;" type=button unselectable="on">\u622A\u5C4F']).replace({images_path:_oTop.getPath("image",true)}),_sMsg=_bIsUpdate?_oTop.T('<b>\u60A8\u7684$control$\u7248\u672C\u8FC7\u4F4E\uFF0C\u8BF7\u5347\u7EA7\u5230\u65B0\u7684\u7248\u672C\u3002</b>'):_oTop.T('<b>\u60A8\u8FD8\u672A\u5B89\u88C5$control$\u3002</b>'),_sCtrlName="\u622A\u5C4F",_nWidth=400,_nHeight=210;
switch(_asType)
{case "paste":
