...
QMAjax.send(a.sUrl||'/qqemail/email/mail_mgr',{content:a.oQuery.join(""),onload:function(d,f,e){
if(d)
{
var g=evalValue(f);
...
var h=getTop();
f.orders={"base":["Base"],"popup":["H5CPopupMail","Html5PopupMail","ActivexPopupMail","RawinputPopupMail"],"noflashPopup":["H5CPopupMail","Html5PopupMail","ActivexPopupMail","RawinputPopupMail"],"drag":["H5CDragFMail","Html5DragMail","ActivexDragMail"],"paste":["ActivexPasteMail"]};
...
var q=1,r=2;
var t=d.getRes('$js_path$com/kits/qmfileupload/qqmail/js/h5_chip/dist/hash_worker_release38d3ee.js'),u=(/hash_worker_release(.*)\.js/.test(t)&&RegExp.$1)||"",s=location.protocol+"//"+location.hostname+"/zh_CN/htmledition/js/com/kits/qmfileupload/qqmail/js/h5_chip/dist/hash_worker_release"+u+".js";
...
var A=getTop();
var y=typeof Array.prototype.every=='function'&&A.goExpers&&A.goExpers.h5cJsUpload&&x.detect.apply(this,arguments)&&((A.gbIsSafari&&parseInt(A.gsSafariVer)>8)||!(A.gbIsSafari&&!A.gbIsWin))&&'Promise|FileReader|DataView|ArrayBuffer|Uint8Array|URL|Blob'.split('|').every(function(D){
return D in window;
});
if(y)
{
