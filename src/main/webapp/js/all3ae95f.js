...
var r='email/$cgi$?folderid=$folderid$&folderkey=$folderkey$$s$&t=$t$&mailid=$mailid$$cache$&sid=$sid$',k,p,o,q,n="readmail";
if(a)
{
p="readmail&s=draft";
}
...
loadJsFileToTop(["$js_path$editor38a71a.js"]);
loadingBox({model:"\u53D1\u4FE1",js:["$js_path$libcompose3847ad.js","$js_path$qmaddrinput24e6ae.js"],oncheck:function(){
...
if(r.charAt(r.length-1)!=":"&&/((?!0000)[0-9]{4}([-/]{1})(?:(?:0?[1-9]|1[0-2])(?:[-/]{1})(?:0?[1-9]|1[0-9]|2[0-8])|(?:0?[13-9]|1[0-2])(?:[-/]{1})(?:29|30)|(?:0?[13578]|1[02])(?:[-/]{1})31)|(?!0000)[0-9]{4}(?:[-/\u5E74]{1})(?:(?:0?[1-9]|1[0-2])\u6708(?:0?[1-9]|1[0-9]|2[0-8])\u65E5|(?:0?[13-9]|1[0-2])\u6708(?:29|30)\u65E5|(?:0?[13578]|1[02])\u670831\u65E5)|(?!\u5E74)(?:(?:0?[1-9]|1[0-2])\u6708(?:0?[1-9]|1[0-9]|2[0-8])\u65E5|(?:0?[13-9]|1[0-2])\u6708(?:29|30)\u65E5|(?:0?[13578]|1[02])\u670831\u65E5)|(?![/-])(?:(?:0?[1-9]|1[0-2])(?:[-/]{1})(?:0?[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])(?:[-/]{1})(?:29|30)|(?:0[13578]|1[02])(?:[-/]{1})31))/g.test(l))
{
...
var d=-1,c=-2,b=-3,e=-4,f=-5,a=-6,n=TE(['inframe/recieve?sid=$sid$&folderid=$folderid$&folderkey=$folderkey$']).replace({sid:getSid(),folderid:i,folderkey:i}),j=h||{};
extend(j,{page:0});
if(j.dr=="ad")
{
...
var a={'comm2010.css':'$css_path$comm2010392e89.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
