<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<!-- saved from url=(0137)https://mail.qq.com/cgi-bin/readtemplate?sid=sL2C4LTRaQ9U1RdN&t=compose&ver=0501&s=cnew&s=left&loc=frame_html,,,21#stattime=1515939331358 -->
<html>
	...
	<head>
		...
		<script language="JavaScript">
			...
			function reloadComposeJS(_abReload) {
				...
				_oTop.localReloadJsFile('https://mail.qq.com/zh_CN/htmledition/js/qmaddrinput2392e83.js', function() {
					return _oTop.QMAddrDomainCheck2
				}, 'qmaddrinput2', _abReload);

				_oTop.localReloadJsFile('https://mail.qq.com/zh_CN/htmledition/js/compose23aa739.js', function() {
					return _oTop.initComposeForPage
				}, 'compose2', _abReload);

				_oTop.localReloadJsFile('https://mail.qq.com/zh_CN/htmledition/js/com/kits/qmeditor/qqmail/release/editor38a71a.js', function() {
					return _oTop.QMEditor
				}, 'editor', _abReload);

				_oTop.localReloadJsFile('https://mail.qq.com/zh_CN/htmledition/js/location_identify/location_identify25f2fd.js', function() {
		...
		<style type="text/css">
			...
			.arrowdown {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/newicon/r_c1e9c5d.gif) no-repeat -48px 0;
				margin: 0 0 -1px 4px;
				height: 12px;
				width: 12px;
			}
			...
			.arrowup {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/newicon/r_c1e9c5d.gif) no-repeat -32px -1px;
				margin: 0 0 -2px 4px;
				height: 12px;
				width: 12px;
			}
			...
			only screen and (min-device-pixel-ratio: 2) {
				.arrowdown,
				.arrowup {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/newicon/r_c1e9c5d.gif) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/newicon/r_c@2X1e9c5d.png) 2x);
				}
			}
		</style>
		<style type="text/css">
		...
		<style type="text/css" cssfrom=",qmEditor,qmNetDisk">
			...
			#page_span img.arrow_tableft_disable {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tableft_disable1e9c5d.gif) no-repeat;
			}
			
			#page_span img.arrow_tableft {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tableft1e9c5d.gif) no-repeat;
			}
			
			#page_span img.arrow_tabright_disable {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tabright_disable1e9c5d.gif) no-repeat;
			}
			
			#page_span img.arrow_tabright {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tabright1e9c5d.gif) no-repeat;
			}
			...
			#stationery_div .design_btn_img {
				...
				width: 12px;
				height: 12px;
				background: url(https://mail.qq.com/zh_CN/htmledition/images/newicon/misc/xinzhi_icon1e9c5d.png) no-repeat -48px 0px;
				position: absolute;
				left: 32px;
				margin-top: 5px;
				*margin-top: 2px;
			...
			only screen and (min-device-pixel-ratio: 2) {
				#page_span img.arrow_tableft_disable {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tableft_disable1e9c5d.gif) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tableft_disable@2X1e9c5d.gif) 2x);
				}
				#page_span img.arrow_tableft {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tableft1e9c5d.gif) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tableft@2X1e9c5d.gif) 2x);
				}
				#page_span img.arrow_tabright_disable {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tabright_disable1e9c5d.gif) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tabright_disable@2X1e9c5d.gif) 2x);
				}
				#page_span img.arrow_tabright {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tabright1e9c5d.gif) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/arrow_tabright@2X1e9c5d.gif) 2x);
				}
			}
			...
			.qmEditorIcon {
				border: none;
				background: url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/editor_new1e9c5d.gif) no-repeat;
				width: 20px;
				height: 16px;
				overflow: hidden;
			}
			...
			.qmEditorSpellChecking .qmEditorIcon {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/checking_loading1e9c5d.gif) center center no-repeat;
				background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/checking_loading1e9c5d.gif) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/checking_loading_2x1e9c5d.gif) 2x);
				width: 23px;
			}
			...
			.menubarbg {
				background-image: url("https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/mailcomposetool24f760.png");
				_background-image: url("https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/mailcomposetool_ie24f760.png");
			}
			...
			.qmpanel_shadow .btn_close {
				...
				background: url(https://mail.qq.com/zh_CN/htmledition/images/newicon/mail327a44.png) no-repeat scroll -96px -19px;
			...
			.qmEdMap_bg {
				height: 126px;
				margin-top: 80px;
				background-image: url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/editor_map248228.png);
				background-repeat: no-repeat;
			...
			.qmEdMap_iconLocation {
				...
				background-image: url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/icon_location24c44c.png);
				background-repeat: no-repeat;
				_width: 22px;
				_height: 32px;
			...
			.icon_editor_arrow_down {
				background-image: url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/compose27b687.png);
				background-repeat: no-repeat;
			}
			...
			.qmEditorResume {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/newicon/compose207c92.png) 0 -682px no-repeat;
			}
			...
			only screen and (min-device-pixel-ratio:2) {
				...
				.icon_editor_arrow_up,
				.icon_editor_arrow_down {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/compose27b687.png) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/compose_2x27b687.png) 2x);
				}
				.menu_item_high .qmEditorMap {
					background-position: 0 -691px;
				}
				.qmEditorResume {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/newicon/compose207c92.png) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/newicon/compose@2X211f08.png) 2x);
				}
				.qmEditorToolBarItem .qmEditorPhoto,
				.qmEditorToolBarItem .qmEditorScreenSnap,
				.qmEditorToolBarItem .qmEditorMo,
				...
				.qmEditorIcon {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/editor_new1e9c5d.gif) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/editor_new@2X1e9c5d.gif) 2x);
				}
				.qmEdMap_bg {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/editor_map248228.png) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/editor_map_2x24825d.png) 2x);
				}
				.qmEdMap_iconLocation {
					background-image: -webkit-image-set(url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/icon_location24c44c.png) 1x, url(https://mail.qq.com/zh_CN/htmledition/images/../js/com/kits/qmeditor/base/images/newicon/icon_location_2x24c44c.png) 2x);
				}
				.qmEdMap_resultMapControl_btn {
			...
			.p-otherdisk .icons {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/icons1e9c5d.png) no-repeat;
			}
			...
			.bind_item {
				...
				color: #ccc;
				text-decoration: none;
				background: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/weiyun26f1bf.png) no-repeat center 20px;
			...
			only screen and (min-device-pixel-ratio:2) {
				.bind_item {
					background-image: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/weiyun_2x26f143.png);
			...
			.bind_item_dropbox {
				background-image: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/dropbox1e9c5d.png);
			}
			...
			.bind_items .has_bind {
				...
				left: 1px;
				top: 1px;
				background: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/has_bind1e9c5d.png) no-repeat;
				z-index: 10;
			}
			...
			.link_error_box .error_tips {
				...
				margin-left: auto;
				margin-right: auto;
				background: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/error_pic1e9c5d.png) center 0px no-repeat;
				margin: 30px 0;
				float: left;
			}
			...
			.p-todisk {
				background: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/bg_rp1e9c5d.png) repeat;
			}
			...
			.todisk_process .ico_dire {
				...
				height: 32px;
				margin: 25px 22px 0;
				background: url(https://mail.qq.com/zh_CN/htmledition/images/xdisk/bind_disk/translate1e9c5d.png) no-repeat;
			}
	...
	<body class="tbody" onbeforeunload="return closePage(event);">
		<div id="dndContainer" class="QMEditorMenuBorder dndContainer" style="top: -400px; left: -400px;">
			<div style="padding:5px 5px 0;font-size:12px;">
				<a class="right" id="dndContainer1515939332113004908597835388395">关闭</a>
			</div>
		...
		<div id="151593933172208575515904201039_QMAutoCompleteMenu" class="" style="background:#fff;display:none;z-index:1121;position:absolute;left:px;top:px; height:315px; ">
			<div style="margin:0px;">
				<div class="menu_base">
					<div class="menu_bd" style="padding:0;">
						<div unselectable="on" id="151593933172208575515904201039_QMAutoCompleteMenu__title_" style="white-space:nowrap;width:220px;line-height:21px;display:none;"></div>
						<div unselectable="on" id="151593933172208575515904201039_QMAutoCompleteMenu__menuall_" style="overflow-y:auto;height:auto;line-height:21px;width:220px"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="1515939331710012522762354131967_QMAutoCompleteMenu" class="" style="background:#fff;display:none;z-index:1121;position:absolute;left:px;top:px; height:315px; ">
			<div style="margin:0px;">
				<div class="menu_base">
					<div class="menu_bd" style="padding:0;">
						<div unselectable="on" id="1515939331710012522762354131967_QMAutoCompleteMenu__title_" style="white-space:nowrap;width:220px;line-height:21px;display:none;"></div>
						<div unselectable="on" id="1515939331710012522762354131967_QMAutoCompleteMenu__menuall_" style="overflow-y:auto;height:auto;line-height:21px;width:220px"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="151593933170303525428929698944_QMAutoCompleteMenu" class="" style="background:#fff;display:none;z-index:1121;position:absolute;left:px;top:px; height:315px; ">
			<div style="margin:0px;">
				<div class="menu_base">
					<div class="menu_bd" style="padding:0;">
						<div unselectable="on" id="151593933170303525428929698944_QMAutoCompleteMenu__title_" style="white-space:nowrap;width:220px;line-height:21px;display:none;"></div>
						<div unselectable="on" id="151593933170303525428929698944_QMAutoCompleteMenu__menuall_" style="overflow-y:auto;height:auto;line-height:21px;width:220px"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="151593933169005075322856876592_QMAutoCompleteMenu" class="" style="background:#fff;display:none;z-index:1121;position:absolute;left:px;top:px; height:315px; ">
			<div style="margin:0px;">
				<div class="menu_base">
					<div class="menu_bd" style="padding:0;">
						<div unselectable="on" id="151593933169005075322856876592_QMAutoCompleteMenu__title_" style="white-space:nowrap;width:220px;line-height:21px;display:none;"></div>
						<div unselectable="on" id="151593933169005075322856876592_QMAutoCompleteMenu__menuall_" style="overflow-y:auto;height:auto;line-height:21px;width:220px"></div>
					</div>
				</div>
			</div>
		</div>
		...
		<form name="importqq_form" method="POST" action="https://mail.qq.com/cgi-bin/addr_importqq?sid=sL2C4LTRaQ9U1RdN" target="actionFrame"><input type="hidden" name="sid" value="sL2C4LTRaQ9U1RdN"><input type="hidden" name="ImportType" value="Replace"></form>
		<form method="post" id="frm" name="frm" target="actionFrame" action="https://mail.qq.com/cgi-bin/compose_send" enctype="multipart/form-data"><input name="content_compare" type="hidden" disabled="" value="&lt;div&gt;&lt;br&gt;&lt;/div&gt;"><input type="hidden" name="08d1ef0ce4b1f2eeff1fe6b2967a3536" value="51109e0d79f8a9ec6dcde8105808ea6f"><input type="hidden" name="sid" value="sL2C4LTRaQ9U1RdN"><input type="hidden" name="bigattachcnt" value=""><input type="hidden" name="exstore" value=""><input type="hidden" name="from_s" value="cnew"><input type="hidden" id="swap" name="swap" value=""><input type="hidden" id="signtype" name="signtype" value=""><input name="newwin" type="hidden" value=""><input name="verifykey" id="verifykey" value="" type="hidden">
					...
					<tr>
						...
						<td>
							...
							<div class="composetab_unsel">
								<div>
									<a class="" onclick="saveContentGoUrl(&#39;/cgi-bin/grouplist?t=compose_group&amp;sid=sL2C4LTRaQ9U1RdN&amp;newwin=&#39;);return false;" hidefocus="">群邮件</a>
								</div>
							</div>
						</td>
						<td>
			...
			<div id="toolbar">
				<div class="toolbg toolbgline" style="background-image:none;">
					...
					<a name="sendbtn" tabindex="9" class="btn_gray btn_space" hidefocus="" href="javascript:;" oldstyledisplay="" disablednodeid="">发送</a>
					<a name="timeSendbtn" tabindex="10" class="btn_gray btn_space" hidefocus="" href="javascript:;" oldstyledisplay="" disablednodeid="">定时发送</a>
					<a name="savebtn" title="存草稿后，您可以在草稿箱中找回" tabindex="10" class="btn_gray btn_space" hidefocus="" href="javascript:;" oldstyledisplay="" disablednodeid="">存草稿</a>
			...
			<div class="readmailinfo" style="border-bottom:1px solid #fff;min-width:650px;_zoom:1;" id="sendtimepadding">
				<div id="rightArea" style="float:right;width:179px!important;width:180px;margin:16px 12px 0 0; margin:14px 14px 0 0\9;filter:none;">
					...
					<div id="AddrTab" class="addrtab cpright" style="">
						<div id="quickaddr_div" style="height: 669px;">
							<div class="lm_sbar"><input type="button" id="lm151593933362209769210023654098cancel" class="lm_sopen">
								<div><input id="lm151593933362209769210023654098searchtext" type="text" class="txt" value="查找联系人..." autocomplete="off"></div>
							</div>
							<div class="lm_panel" style="height: 635px;">
								<div id="lm151593933362209769210023654098tree">
									...
									<div class="groupsub" key="t2" sub="1">
								...
								<div id="lm151593933362209769210023654098search" style="display:none;"></div>
							</div>
						</div>
					</div>
				...
				<div id="rightAreaBtnWarp" style="float: right; margin: 200px 3px 0px 6px; height: 469px;">
									...
									<td class="content_title" width="99%" style="*padding-right:4px;">
										<div id="scAreaCtrl" class="noime div_txt" style="cursor: text;">
											...
											<div class="addr_text" style="float:left;border:none;overflow:hidden;width:13px;"><input type="input" class="js_input" style="border:none;outline:none;-webkit-appearance:none;width:100%;" tabindex="2" autocomplete="off">
												<div style="width: 1px; height: 1px; overflow: auto; white-space: nowrap; border: none; margin: 0px; padding: 0px; font-family: Tahoma; font-size: 12px; font-weight: normal; line-height: normal; word-spacing: 0px;"></div>
											</div>
...
会对多个人一对一发送。每个人将收到单独发给他/她的邮件。" href="javascript:;">分别发送</a>
								...
								<div class="addrtitle right" style="display:none;">您是否还要找：<span id="addrAssociation"><a href="https://mail.qq.com/cgi-bin/readtemplate?sid=sL2C4LTRaQ9U1RdN&amp;t=compose&amp;ver=0501&amp;s=cnew&amp;s=left&amp;loc=frame_html,,,21">nicoyang</a>，<a href="https://mail.qq.com/cgi-bin/readtemplate?sid=sL2C4LTRaQ9U1RdN&amp;t=compose&amp;ver=0501&amp;s=cnew&amp;s=left&amp;loc=frame_html,,,21">angusdu</a>, <a href="https://mail.qq.com/cgi-bin/readtemplate?sid=sL2C4LTRaQ9U1RdN&amp;t=compose&amp;ver=0501&amp;s=cnew&amp;s=left&amp;loc=frame_html,,,21">allen</a></span></div>
								<div class="clr"></div>
							</div>
						</div>
					</div>
				...
				<div class="input_title" style="padding-top:10px;padding-bottom:8px;" onmousedown="QMAttach.hideDragAndDropContainer();"> <span style="display:none" id="attachupload"></span> <span id="composecontainer"><span class="compose_toolbtn qmEditorAttach dragAndDropTrap_box"><span sizelimit="50" title="添加小于 50M 的文件作为附件" id="AttachFrame" onmouseover="getTop().addClass(getTop().finds(&#39;a&#39;,this)[0],&#39;underline&#39;);" onmouseout="getTop().rmClass(getTop().finds(&#39;a&#39;,this)[0],&#39;underline&#39;);" onmousedown="getTop().LogKV(&#39;compose|toolbar|entrance|attach&#39;);" style="position: relative;"><span style="top: 0px; left: 0px; position: absolute; cursor: pointer; width: 66px; height: 15px; overflow: hidden; background-color: rgb(255, 255, 255); zoom: 1; opacity: 0; z-index: 1;"><input type="file" title=" " name="UploadFile" multiple="" style="font-family: Times; position: absolute; cursor: pointer; width: 2000px; height: 600px; right: 0px;"></span>
					...
					</script><span class="compose_toolbtn qmEditorAttachBig" onmousedown="return false;" ftnv2="true" onclick="getTop().LogKV(&#39;compose|toolbar|entrance|span_online_doc&#39;);showAddOnlineDocDlg();return false" title="在线文档" id="span_online_doc"><a class="compose_toolbtn_text ico_editDoc" style="padding-left:20px;" hidefocus="">在线文档</a></span></span><span id="QMEditorToolBarPlusArea"><span class="editor_btn unselect qmEditorPhotoWrap" style="position: relative;"><a class="editor_btn_text qmEditorPhoto " style="position: relative;"><span style="top: 0px; left: 0px; position: absolute; cursor: pointer; width: 44px; height: 20px; overflow: hidden; background-color: rgb(255, 255, 255); zoom: 1; opacity: 0; z-index: 1;"><input type="file" title=" " name="UploadFile" multiple="" style="font-family: Times; position: absolute; cursor: pointer; width: 2000px; height: 600px; right: 0px;"></span>照片</a><span class="ico_moreupload" opt="more"></span></span><span class="editor_btn unselect" id="editor_word_compose_tip" style="position: relative;"><a class="editor_btn_text qmEditorWord " style="position: relative;"><span style="top: 0px; left: 0px; position: absolute; cursor: pointer; width: 42px; height: 20px; overflow: hidden; background-color: rgb(255, 255, 255); zoom: 1; opacity: 0; z-index: 1;"><input type="file" title=" " name="UploadFile" multiple="" style="font-family: Times; position: absolute; cursor: pointer; width: 2000px; height: 600px; right: 0px;"></span>文档</a>
					...
					</script><span class="editor_btn" style="margin-right:0;"><a id="editor_toolbar_btn_container" unselectable="on" onmousedown="return false;" class="editor_btn_text qmEditorTxtStyle"><font class="editor_netdisk_txtmini">格式</font><span style="display: none;">↑</span><span>↓</span></a>
					</span>
				</div>
						...
						<tbody>
							<tr>
								...
								<td class="content_title" style="padding-top:1px!important;padding-top:0;padding-right:0;width:99%;" valign="top"><textarea id="content" name="content__html" style="display:none;"></textarea>
									<div id="QMEditorArea" style="position: relative; height: 573px;" tindex="3" acckey="q" qmeditorid="compose">
...
提示：步骤2中若双击格式刷，可连续执行步骤3。">
												...
												<tr>
													<td height="100%" valign="top" unselectable="on" class="qmEditorContent"><iframe frameborder="0" scrolling="auto" id="_151593933174807776300799177305" name="_151593933174807776300799177305" class="qmEditorIfrmEditArea" onload="this.setAttribute(&#39;loaded&#39;,&#39;true&#39;);_creAteifRAmeoNlQAd_(&#39;_151593933174807776300799177305&#39;,this);" src="javascript:(function(){document.open();document.domain=&#39;mail.qq.com&#39;;frameElement[&#39;_render_&#39;]=1;try{document.write(&#39;&lt;head&gt;&lt;script&gt;window.onerror=function(){return true};&lt;/script&gt;&#39;+parent[&#39;_cAcheBYifRAme_&#39;][&#39;_151593933174807776300799177305_h&#39;]+&#39;&lt;/head&gt;&#39;+parent[&#39;_cAcheBYifRAme_&#39;][&#39;_151593933174807776300799177305_b&#39;]);parent[&#39;_cAcheBYifRAme_&#39;][&#39;_151593933174807776300799177305_h&#39;]=parent[&#39;_cAcheBYifRAme_&#39;][&#39;_151593933174807776300799177305_b&#39;]=null;}catch(e){alert(e.message);}document.close();})()" style="" hidefocus="" tabindex="3" loaded="true" cbi_inited="true" src="./saved_resource(4).html"></iframe><textarea class="qmEditorText" tabindex="3" style="display:none;font-size:12px;"></textarea><textarea class="qmEditorText" tabindex="3" style="display:none;font-size:12px;"></textarea></td>
												</tr>
											</tbody>
										</table>
...
将丢失正文颜色等">纯文本</label>&nbsp;&nbsp;<input id="noletter" name="noletter" value="1" type="checkbox" style="margin:2px 1px 0 0;_margin-top:-5px;vertical-align:middle;" onclick="" title=""><label style="cursor:pointer;vertical-align:middle;" for="noletter" title="">使用信纸</label></span><wbr><span class="nowrap left" style="position:relative;"><input title="加密" type="checkbox" name="secmailcode" id="secmailcode" value="" style="margin:2px 1px 0 0;_margin-top:-5px;vertical-align:middle;"><label style="cursor:pointer;vertical-align:middle;" for="secmailcode">对邮件加密</label></span></div>
			...
			<div id="toolbar" class="clear">
				<div class="toolbg toolbgline">
					<a name="sendbtn" tabindex="5" class="btn_gray btn_space" hidefocus="" href="javascript:;" oldstyledisplay="" disablednodeid="">发送</a>
					<a name="timeSendbtn" tabindex="6" class="btn_gray btn_space" hidefocus="" href="javascript:;" oldstyledisplay="" disablednodeid="">定时发送</a>
					<a name="savebtn" title="存草稿后，您可以在草稿箱中找回" tabindex="7" class="btn_gray btn_space" hidefocus="" href="javascript:;" oldstyledisplay="" disablednodeid="">存草稿</a>
...

			{
				...
				_oTop.initComposeForPage("compose", window,

					{
						...
						sLocIcon: "https://mail.qq.com/zh_CN/htmledition/images/newicon/icon_locationCompose24c9f7.png",

						sLocIcon2x: "https://mail.qq.com/zh_CN/htmledition/images/newicon/icon_locationCompose_2x24c9f7.png",
		...
		<script type="text/javascript" src="./stationery_new28766e.js"></script>
		<link rel="stylesheet" type="text/css" href="../css/getcss.css">
		<style type="text/css">
			body {
				background: #fff;
		...
		<!--<script type="text/javascript" src="https://mail.qq.com/zh_CN/htmledition/js/bj-report39afc1.js"></script>-->
		<script type="text/javascript">
	...
	<!--<script type="text/javascript" src="https://mail.qq.com/zh_CN/htmledition/js/speed-report29d207.js"></script>-->
